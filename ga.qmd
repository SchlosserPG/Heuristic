...
Genes/Chromosomes: Each individual is represented by a chromosome (a string of genes), typically encoded as a binary, real-number, or symbolic representation.
...
* Diagram illustrating the flow of a genetic algorithm: 
...
* The objective value of each chromosome will also be transformed to a value called the _fitnes value_ by a so-called fitness function.
...
* The probability of each chromosome being elected as a parent can be computed as follows: 
